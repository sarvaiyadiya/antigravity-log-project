"""
Script to generate notebooks/practical_10_pipeline.ipynb cleanly.
"""
...
output_file = os.path.join(os.path.dirname(__file__), "..", "notebooks", "practical_10_pipeline.ipynb")
